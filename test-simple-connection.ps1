Write-Host "Testing Simple MySQL Connection to VnSQL Server..." -ForegroundColor Green
...
Write-Host "Password: password (or any password for SimpleMySQLHandler)" -ForegroundColor Yellow

Write-Host "`nPress any key to stop the server..." -ForegroundColor Magenta
